...
function [show savesequence]=loadimages(imgtri, imgblank, sd, hz, iy, ix, tr, T, Tb2,savesequence,j,screen,numstim)
    savesequence(j,1)=tr;
    if numstim==6;
        if sd==0 & hz==0; %Left top
            savesequence(j,2:7)=[T.Var1(tr) T.match(tr) Tb2.Var4(tr) Tb2.neighbour(tr) Tb2.Var4(tr+200) Tb2.neighbour(tr+200) ];
        ...
        elseif sd==0 && hz==2; %left middle
            ...
            show.imdataTL=imgblank{Tb2.Var4(tr+200)}; %tri image
            show.imagetexTL=Screen('MakeTexture', screen.w, show.imdataTL(1:iy, 1:ix,:));
            show.RectTL=Screen('Rect', show.imagetexTL);
            %topright
         ...
         elseif sd==0 && hz==1; %left bottom
            ...
            show.RectTR=Screen('Rect', show.imagetexTR);
            %bottomleft
            show.imdataBL=imgtri{T.Var1(tr)};
            show.imagetexBL=Screen('MakeTexture', screen.w, show.imdataBL(1:iy, 1:ix,:));
            show.RectBL=Screen('Rect', show.imagetexBL);
            %bottomright
        ...
        elseif sd==1 && hz==0; %right top
            ...
            show.imdataTL=imgblank{T.match(tr)}; %tri image
            show.imagetexTL=Screen('MakeTexture', screen.w, show.imdataTL(1:iy, 1:ix,:));
            show.RectTL=Screen('Rect', show.imagetexTL);
            %topright
            show.imdataTR=imgtri{T.Var1(tr)}; %it's luminance match
            show.imagetexTR=Screen('MakeTexture', screen.w, show.imdataTR(1:iy, 1:ix,:));
            show.RectTR=Screen('Rect', show.imagetexTR);
            %bottomleft
        ...
        elseif sd==1 && hz==2; %right middle
            ...
            show.imdataTL=imgblank{Tb2.neighbour(tr+200)}; %tri image
            show.imagetexTL=Screen('MakeTexture', screen.w, show.imdataTL(1:iy, 1:ix,:));
            show.RectTL=Screen('Rect', show.imagetexTL);
            %topright
            ...
            show.RectL=Screen('Rect', show.imagetexL);
            %right
            show.imdataR=imgtri{T.Var1(tr)}; 
            show.imagetexR=Screen('MakeTexture', screen.w, show.imdataR(1:iy, 1:ix,:));
            show.RectR=Screen('Rect', show.imagetexR);

         elseif sd==1 && hz==1; %right bottom
            ...
            show.RectBL=Screen('Rect', show.imagetexBL);
            %bottomright
            show.imdataBR=imgtri{T.Var1(tr)};
            show.imagetexBR=Screen('MakeTexture', screen.w, show.imdataBR(1:iy, 1:ix,:));
            show.RectBR=Screen('Rect', show.imagetexBR);
            %left
        ...
        elseif numstim==2;
           if sd==0 %Left
                savesequence(j,2:3)=[T.Var1(tr) T.match(tr)]; 
                show.imdataL=imgtri{T.Var1(tr)};
                show.imagetexL=Screen('MakeTexture', screen.w, show.imdataL(1:iy, 1:ix,:));
                show.RectL=Screen('Rect', show.imagetexL);
                %right
            ...
            elseif sd==1; %right middle
                savesequence(j,2:3)=[T.match(tr) T.Var1(tr)];
                %left
                show.imdataL=imgblank{T.match(tr)}; 
                show.imagetexL=Screen('MakeTexture', screen.w, show.imdataL(1:iy, 1:ix,:));
                show.RectL=Screen('Rect', show.imagetexL);
